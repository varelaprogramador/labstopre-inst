...
export default function Cosmeticos() {
  return (
    <div className="flex flex-col min-h-screen bg-white min-w-full overflow-x-hidden ">
      ...
      <section className="flex flex-col justify-between text-white  w-full bg-[url('/banner-cosmetico.png')] bg-cover bg-center bg-no-repeat min-h-[85vh] py-[14px] px-[18vw] max-md:px-5 ">
        ...
        <div className='w-[55%] max-md:w-full flex-col flex gap-2'>
          ...
          <button className='bg-purple-500 p-[16px] text-sm mt-4 rounded-md font-semibold shadow-md'>
          VER COSMÉTICOS
          </button>
        </div>
        <div className=''></div>
      ...
      <section className='flex flex-col py-[28px] px-[18vw]  max-md:px-5'>
        ...
        <div className='mt-9 flex flex-col justify-center items-center'>
          <p className='text-purple-800 font-semibold self-start'> SOBRE NÓS</p>
          <h2 className='font-bold text-4xl'>Entenda porque a Labstore é referência nosetor agrícola -<span className='text-purple-800'> Produtos de Alta Precisão</span></h2>
          <div className='w-full min-h-[550px] bg-gray-300 rounded-md mt-4 flex justify-center items-center'>VIDEO</div>
          <button className='bg-purple-600 p-[8px] text-sm mt-4 rounded-md text-white'>
            VER MEDIDORES
          </button>
        </div>
      </section>
      <section className='flex flex-col py-[28px] px-[18vw]  max-md:px-5'>
        <div className='flex flex-col justify-center items-center'>
          <p className='text-purple-800 font-semibold self-start'> MEDIDORES</p>
          <h2 className='font-bold text-4xl border-l-[1px] border-purple-800 self-start px-2'>Confira abaixo os nossos cosméticos </h2>
        ...
        <div className='grid grid-cols-2 gap-4 max-md:grid-cols-1 py-[80px]'>
          <article className='border shadow-sm flex flex-col gap-4 pb-4 px-4 justify-center items-center '>
            ...
            <button className='bg-purple-600 p-[8px] text-white text-sm mt-4 rounded-md'>
              CONHECER
            </button>
          </article>
          <article className='border shadow-sm flex flex-col gap-4 pb-4 px-4 justify-center items-center '>
        ...
        <div className=' flex justify-center'>
          <button className='bg-purple-600 p-[8px] text-white text-sm  rounded-md'>
            MAIS PRODUTOS
          </button></div>
        ...
        <div className='flex justify-center items-center mt-[128px] max-md:flex-col  gap-4'>
          <div className='flex flex-col text-center'>
            <div className='flex flex-col border-gray-100 hover:bg-gray-50 transition-all duration-300 border-b-[1px] p-4 justify-center items-center'>
              <h2 className=' text-purple-800 font-bold text-6xl'>38</h2>
            ...
            <div className='flex flex-col border-gray-100 border-b-[1px] hover:bg-gray-50 transition-all duration-300 p-4 justify-center items-center'>
              <h2 className=' text-purple-800 font-bold text-6xl'>+1,000</h2>
              <p className=" text-sm font-semibold">VENDIDOS</p>
            </div>
            <div className='flex flex-col border-gray-100 border-b-[1px] hover:bg-gray-50 transition-all duration-300 p-4 justify-center items-center'>
              <h2 className=' text-purple-800 font-bold text-6xl'>255</h2>
            ...
            <div className='flex flex-col justify-center p-4 hover:bg-gray-50 transition-all duration-300 items-center'>
              <h2 className=' text-purple-800 font-bold text-6xl'>15</h2>
          ...
          <div className='flex flex-col max-w-[35vw] max-md:max-w-[500px] px-4'>
            <p className='text-purple-800 font-semibold self-start'> SERVIÇOS</p>
            <h2 className='font-bold text-4xl border-l-[1px] border-purple-800 self-start px-2'>Você sabia que nós também somos especializados em manutenções?</h2>
         ...
         <button className='bg-purple-600 p-[8px] text-sm text-white mt-4 rounded-md'>
           QUERO SABER MAIS
          </button>
         </div>
            </div>
      ...
      <section className='p-8 bg-white max-md:p-0'>
        <div className='flex flex-col py-[28px] px-[18vw] rounded-md min-h-screen text-white bg-purple-800 justify-center items-center'>
        <h2>BENEFÍCIOS</h2>
...
<div className="flex flex-col items-center justify-center text-center gap-2">
  ...
  <p>Graças à sua tecnologia avançada, os modelos Labstore oferecem leituras extremamente precisas, garantindo confiança nos resultados.</p>
         ...
         <section className='flex gap-4 py-[170px] px-[18vw] justify-center items-center max-md:flex-col  max-md:px-5'>
          <div>
<Image src={"/local.jpg"} width={750} height={400} alt='teste' className='border-2 border-purple-800'></Image>
          </div>
          <div className='flex flex-col gap-4 justify-between min-h-[35vh]'>
            <h2 className='text-5xl font-semibold border-l-2 border-purple-800 pl-1'>Procure a labstore mais próxima</h2>
            ...
            <div className='grid grid-cols-2 max-lg:grid-cols-1 gap-8 mt-3'>
              <div className='px-4'>
                <p className='text-purple-800 text-lg'>Cidade: Curitiba – PR</p>
         ...
         <p className='text-purple-800 font-semibold '>DEPOIMENTOS DE CLIENTES</p>
         <h2 className='text-5xl font-semibold border-l-2 border-purple-800 pl-1'>Conheça a opinião de quem conhece e usa os Medidores de Umidade Labstore</h2>
         ...
         <section className='flex flex-col  py-[170px] px-[18vw] justify-center items-center min-h-[70vh]  max-md:px-5'>
          <p className='text-purple-800 font-bold'>BLOG</p>
          ...
          <button className='bg-purple-600 text-white p-[16px] text-sm mt-16 rounded-md'>
          CONHECER BLOG
          </button>
         </section>
         <div className='bg-purple-500 w-full min-w-[300px] max-w-[1000px]  p-8 pb-10 mb-[-20px]   hidden max-md:flex flex-col z-10  max-md:px-5'>
            ...
            <label>Nome</label>
              ...
              <button className='bg-purple-600 s hover:bg-purple-900 transition-all duration-300 p-4 self-end text-sm mt-4 rounded-md'>
            Enviar Email
          </button>
            </div>

          </div>
         <footer className='min-h-[50vh] bg-[#39157a] relative flex flex-col justify-center items-center  rounded-t-3xl z-20 shadow-md'>
          <div className='bg-[#6327b1] shadow-md w-[65vw] min-w-[300px] max-w-[1000px] top-[-80px] rounded-3xl absolute p-8  flex max-md:hidden  max-md:px-5'>
            <div className='flex flex-col text-white justify-center p-4'>
              <p>NEWSLETTER</p>
              <h2 className='text-4xl font-semibold'>Cadastre-se na Newsletter da Labstore!</h2>
              <p>Faça seu cadastro gratuitamente e comece a ficar por dentro de todas as novidades e promoções da Labstore!</p>
            ...
            <label>Nome</label>
              ...
              <label>Email</label>
              <input type='text' placeholder='Digite seu email aqui ...'  className='p-2 rounded-sm w-full text-black'></input>
              <button className='bg-purple-600 hover:bg-purple-900 transition-all duration-300 p-4 self-end text-sm mt-4 rounded-md'>
            Enviar Email
          </button>
            </div>
