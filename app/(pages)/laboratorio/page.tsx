...
export default function laboratorio() {
  return (
    <div className="flex flex-col min-h-screen bg-white min-w-full overflow-x-hidden ">
      ...
      <section className="flex flex-col justify-between text-white  w-full bg-[url('/banner-lab.png')] bg-cover bg-center bg-no-repeat min-h-[85vh] py-[14px] px-[18vw] max-md:px-5 ">
